...
"""
Test script cho crazy_flies.usd (dùng UAV_CFG).

Chạy:
    ./isaaclab.sh -p source/isaaclab_assets/isaaclab_assets/uav/usd_file/test_crazy_flies.py
"""
...
parser = argparse.ArgumentParser(description="Test script cho Crazyflie UAV_CFG.")
